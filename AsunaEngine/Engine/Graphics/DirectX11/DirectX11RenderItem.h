...
namespace asuna
{
	...
	public:
        ...
        void Render(const std::shared_ptr<Material>& overrideMaterial) const override;
    ...
    private:
        ...
        void DrawMesh(DirectX11RenderContext* context, const std::shared_ptr<Material>& overrideMaterial) const;
	};
}
