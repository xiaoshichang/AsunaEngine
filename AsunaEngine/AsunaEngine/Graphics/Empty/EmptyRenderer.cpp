...
std::shared_ptr<ConstantBuffer> asuna::EmptyRenderer::CreateConstantBuffer(ConstantBufferDataType dt)
{
...
std::shared_ptr<RenderItemQueue> EmptyRenderer::CreateRenderItemQueue()
{
